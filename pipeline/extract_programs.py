    ...
    return {
        ...
        "rules": ALL("BA Plan I degree requirements", of=[
            ...
            HRS(3, "Social science (a social science field)",
                filter={"list": "cola-social-science",
                        "label": "Social science coursework (COLA approved list)"},
                source=SRC(edition, page,
            ...
            HRS(3, "Cultural expression, human experience, and thought",
                filter={"list": "cola-cultural-expression",
                        "label": "Cultural expression / human experience / thought (COLA approved list)"},
                source=SRC(edition, page,
        ...
        "rules": ALL("Major requirements", of=[
            ...
            ANY(1, "Tools course", of=[
                ...
                {"type": "concentration", "hours": 6, "upperHours": 6,
                 "includeSubjects": FOREIGN_LANG_SUBJECTS,
                 "title": "Upper-division foreign language option (one language)"},
            ], source=src()),
            GPA(2.0, "GPA of at least 2.00 in the major",
